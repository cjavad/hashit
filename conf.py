...
latex_documents = [
    (master_doc, 'hashit.tex', 'hashit Documentation',
     'Javad Shafique', 'manual'),
]
...
man_pages = [
    (master_doc, 'hashit', 'hashit Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'hashit', 'hashit Documentation',
     author, 'hashit', 'One line description of project.',
     'Miscellaneous'),
]
