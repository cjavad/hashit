...
LINUX_LIST = ['Mythbuntu', 'Mac OS X', 'Debian Pure Blend', 'RPM', 'Symphony OS', 'Astra Linux', 'Emdebian Grip',\
    ...
    'Parabola GNU/Linux-libre', 'Go', 'Ututo', 'Dreamlinux', 'Red Flag Software', 'Sunwah Linux', 'LOUD', 'Yellow Dog Linux', 'Trinity Rescue Kit',\
    ...
    'Canaima', 'Kurumin', 'Moblin', 'Vyatta', 'Kubuntu', 'Pentoo', 'GIS', 'YUM', 'Topologilinux', 'WinLinux', 'autonomic',\
    'CentOS', 'CRUX', 'Trustix','Galsoft Linux', 'Sugar-on-a-Stick Linux', 'BackBox', 'simpleLinux', 'Smallfoot', 'BackSlash Linux', 'HandyLinux',\
    'Funtoo Linux', 'Element OS', 'Ubuntu Budgie', 'YOPER', 'Xbox', 'Corel Linux', 'Webconverger', 'PelicanHPC', 'PUD', 'HostGIS',\
    ...
    'Thinstation', 'elementary OS', 'Void Linux', 'Rocks Cluster Distribution', 'Lubuntu', 'gOS', 'Ubuntu TV', 'Openbox', 'Sharp Zaurus', 'PS2 Linux', 'DAVIX', 'MintPPC', 'Kali Linux',\
    'ThoughtWorks', 'Qimo 4 Kids', 'Nitix', 'SUSE Linux Enterprise Desktop', 'GendBuntu', 'Buildix', 'Impi Linux', 'Linux Lite', 'Guix System Distribution', 'Turbolinux', 'Maemo',\
